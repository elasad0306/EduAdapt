...
function Modifprofile(){
	...
	return (
		<>
		<Navbar />
		<div className="container bg-sky-100 mx-auto p-6 mt-6 rounded-lg shadow-lg">
			<h1 className="text-2xl mb-4 text-center">Modifier mon profil</h1>
			<div className="flex gap-6">
				<form className="w-full bg-white p-6 rounded shadow" onSubmit={handleSubmit}>
					<InputWithLabel 
                        NameLabel="Prénom*" 
                        idInput="firstname" 
                        value={form.firstname}
                        style="border w-full rounded active:border-sky-500 focus:outline-1 focus:outline-sky-500 p-2 input-shadow mb-4"
